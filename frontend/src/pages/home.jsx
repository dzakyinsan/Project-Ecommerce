    ...
    return (
      <div>
        ...
        <div className="home-menu-football">
          <div className="category-title">FOOTBALL BOOTS</div>
          <div className="row">
            <div className="col-md-6 container">
              <img className="d-block w-100 image" src="https://usatftw.files.wordpress.com/2014/04/su14_gfb_merc_hi_3qf_pnk_v3_29207.jpg?w=1000&h=600&crop=1" alt="First slide" />
        ...
        <div className="home-menu-basketball">
          <div className="row">
            <div className="col-md-6">
              <div className="category-title">BASKETBALL BOOTS</div>
              ...
              <img width='250' className='image-basketballhome' src="https://c.static-nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5/6d97d0e0-da46-4924-a1d1-836f99cce6cd/lebron-17-monstars-basketball-shoe-XShGJ1.jpg" />
              <img width='250' className='image-basketballhome' src="https://c.static-nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5/i1-80a2a2fc-f109-4fb1-a51e-60eda3f1012b/pg-4-ep-basketball-shoe-9FgFQx.jpg" />
              <img width='250' className='image-basketballhome' src="https://c.static-nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5/atlpsqutgb0hjmljpxce/zoom-rise-basketball-shoe-xJvCBl.jpg" />
